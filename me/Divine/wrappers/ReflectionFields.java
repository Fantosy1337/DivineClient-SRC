...
public class ReflectionFields
{
    ...
    public static double getRenderPosX() {
        try {
            return (double)ReflectionFields.renderPosX.get(Minecraft.func_71410_x().func_175598_ae());
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    public static double getRenderPosY() {
        try {
            return (double)ReflectionFields.renderPosY.get(Minecraft.func_71410_x().func_175598_ae());
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static double getRenderPosZ() {
        try {
            return (double)ReflectionFields.renderPosZ.get(Minecraft.func_71410_x().func_175598_ae());
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static float getPlayerViewY() {
        try {
            return (float)ReflectionFields.playerViewY.get(Minecraft.func_71410_x().func_175598_ae());
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static float getPlayerViewX() {
        try {
            return (float)ReflectionFields.playerViewX.get(Minecraft.func_71410_x().func_175598_ae());
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static Timer getTimer() {
        try {
            return (Timer)ReflectionFields.timer.get(Minecraft.func_71410_x());
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static ModelManager getModelManager() {
        try {
            return (ModelManager)ReflectionFields.modelManager.get(Minecraft.func_71410_x());
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static void rightClickMouse() {
        try {
            ReflectionFields.rightClickMouse.invoke(Minecraft.func_71410_x(), new Object[0]);
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static Map<ResourceLocation, ITextureObject> getMapTextureObjects() {
        try {
            return (Map<ResourceLocation, ITextureObject>)ReflectionFields.mapTextureObjects.get(Minecraft.func_71410_x().func_110434_K());
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static void setRightClickDelayTimer(final int value) {
        try {
            ReflectionFields.rightClickDelayTimer.set(Minecraft.func_71410_x(), value);
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static void setHorseJumpPower(final float value) {
        try {
            ReflectionFields.horseJumpPower.set(Minecraft.func_71410_x().field_71439_g, value);
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static float getCurBlockDamageMP() {
        try {
            return (float)ReflectionFields.curBlockDamageMP.get(Minecraft.func_71410_x().field_71442_b);
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static void setCurBlockDamageMP(final float value) {
        try {
            ReflectionFields.curBlockDamageMP.set(Minecraft.func_71410_x().field_71442_b, value);
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static int getBlockHitDelay() {
        try {
            return (int)ReflectionFields.blockHitDelay.get(Minecraft.func_71410_x().field_71442_b);
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static void setBlockHitDelay(final float value) {
        try {
            ReflectionFields.blockHitDelay.set(Minecraft.func_71410_x().field_71442_b, value);
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static void setSession(final Session newSession) {
        try {
            ReflectionFields.session.set(Minecraft.func_71410_x(), newSession);
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
    ...
    public static float getFoodExhaustionLevel() {
        try {
            return (float)ReflectionFields.foodExhaustionLevel.get(Minecraft.func_71410_x().field_71439_g.func_71024_bL());
        }
        catch (Exception e) {
            e.printStackTrace();
            throw new IllegalStateException(e);
